...
function zoomInCharts(options) {
    ...
    switch (options.title) {
        //highchartjs
        case 'وقایع چهارگانه حیاتی شهرستان مشهد سال های 93 تا 96':
            getBarHighchart({
                Id: options.Id
            });
            break;
        case 'جمعیت نواحی به تفکیک':
            getAreaHighchart({
                Id: options.Id
            });
            break;
        ...
        case 'اصناف در شهر':
            ...
            break;
        case 'کسب کار ها در منطق 13 گانه':
            getBubbleHighchart({
                Id: options.Id
            });
            break;
        ...
        //c3.js
        case 'تعداد زائران سال های 93 تا 96 در شهر مشهد':
            getBarC3Js({
                Id: options.Id
            });
            break;
        case 'وضعیت اشتغال در شهر مشهد':
            getDonutC3Js({
                Id: options.Id
            });
            break;
        ...
        case 'درآمد شهری در سال های 93 تا 96':
        ...
        case 'گردش مالی شهرداری':
            ...
            break;
        case 'امید به زندگی در مناطق 13 گانه شهرستان مشهد':
            // Temporary fix to append canvas in html for the chartjs
            var canv2 = document.createElement("canvas");
