var getBubbleC3Js = function (element) {
    var bubbleChart = c3.generate({
        ...
        data: {
            ...
            columns: [
                ["دما", 76.5, 68.3, 79.3, 81.2, 82.4, 82.7, 62.9, 82.2, 74.5, 82.8, 81.9, 77.1],
                ["بارش", 1.6, 2.43, 1.87, 1.88, 2.07, 1.44, 2.29, 1.6, 2.09, 1.77, 1.78, 2.32],
                ["رطوبت", 1409517397, 1339180127, 322179605, 66181585, 64979548, 59359900, 56717156, 36624199, 32938213, 24450561, 17035938, 9400145]
    ...
    function loadChart(id) {
        var legendArray = ['دما', 'بارش', 'رطوبت']
